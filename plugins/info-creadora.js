...
description = official[0][0] == String(contact[0]) ? 'AI NITORI' : official[1][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[2][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[3][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : desc === '' ? lenguajeGB.smsContacto5() : desc
correo = official[0][0] == String(contact[0]) ? 'soportedurl@yahoo.com' : official[1][0] == String(contact[0]) ? 'durlingmedrano108@gmail.com' : official[2][0] == String(contact[0]) ? '-' : mail === '' ? lenguajeGB.smsContacto6() : mail
...
enlace = official[0][0] == String(contact[0]) ? 'private' : official[1][0] == String(contact[0]) ? 'private' : official[2][0] == String(contact[0]) ? 'private' : official[3][0] == String(contact[0]) ? 'private' : md 
...
await conn.sendFile(m.chat, pp, 'lp.jpg', cat, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' AI Nitori  ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb.getRandom()}}})
...
//------- Nombre
  ...
  let insta = `https://www.instagram.com/90pboy_`
  let teksnomor = `
• @${wm.split`@`[0]} •
------- ${wm} -------
`
conn.reply(m.chat, 'Durl', fkontak,  m)
//------------ BIO
